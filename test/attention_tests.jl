...
@testset "RoPE Tests" begin
    ...
    @testset "STRINGRoPE Translational Invariance" begin
        ...
        for d_coords in [1, 3, 5]
            ...
            block = STRINGTransformerBlock(dim, n_heads, d_coords; init_scale=10) # High init_scale to stress test
            out = block(x,pos)
            ...
            block = AdaSTRINGTransformerBlock(dim, dim, n_heads, d_coords; init_scale=10)
