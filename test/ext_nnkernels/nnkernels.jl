...
@testset "NNkernels Extension" begin
    ...
    @testset "rms_norm matches DefaultBackend" begin
        ...
        y = Onion.rms_norm(NNkernelsBackend(), x, w; eps=1f-5, offset=0f0)
        @test y ≈ ref
    end
    ...
    @testset "layer_norm matches DefaultBackend" begin
        ...
        y = Onion.layer_norm(NNkernelsBackend(), x, w, b; eps=1f-6)
        @test y ≈ ref
    end
    ...
    @testset "attention matches DefaultBackend" begin
        ...
        y = Onion.attention(NNkernelsBackend(), q, k, v)
